...
'Active topics': 'Actieve topics',
'Add': 'Toevoegen',
'Add Record': 'Record toevoegen',
'Add record to database': 'Record toevoegen aan database',
'Add this to the search as an AND term': 'Voeg dit toe aan de zoekfunctie als een AND term',
'Add this to the search as an OR term': 'Voeg dit toe aan de zoekfunctie als een OR term',
'Add topic reply': 'Voeg reactie toe',
...
'Amount members': 'Aantal gebruikers',
'Amount topic replys': 'Aantal reacties',
'Amount topics': 'Aantal topics',
'Amount viewed': 'Aantal x bekeken',
'And': 'En',
...
'Forbidden': 'Verboden',
'Forgot username?': 'Gebruikersnaam kwijt?',
'Forms and Validators': 'Formulieren en Validators',
'Forum Name': 'Forum Naam',
...
'Last Updated': 'Laatst geüpdated',
'Latest topics from': 'Laatste topics van',
'Layout': 'Layout',
...
'New Search': 'Nieuwe zoekactie',
'New topic': 'New topic',
'Newest member': 'Nieuwste gebruiker',
'Next': 'Volgende',
'next %s rows': 'volgende %s rows',
'next 100 rows': 'volgende 100 rijen',
'Next page': 'Volgende pagina',
'NO': 'NEE',
'No databases in this application': 'Geen database in deze applicatie',
'No records found': 'Geen record gevonden',
'None': 'None',
'not in': 'not in',
...
'There are no topic replys yet in this topic': 'Er zijn nog geen topic reacties in dit topic',
'There are no topics yet found from': 'Er zijn nog geen topics gevonden van',
'There are no topics yet in this forum.': 'Er zijn nog geen topics gevonden in dit forum.',
...
'This App': 'Deze App',
'This email already has an account': 'Dit e-mailadres heeft al een account',
...
'Topic': '',
'Topic Id': 'Topic Id',
'Topic replies': 'Topic reacties',
'Topic replys': 'Topic replys',
'Topic Text': 'Topic tekst',
'Topic title': 'Topic titel',
'Topic Title': 'Topic titel',
'Topics': 'Topics',
'Traceback': 'Traceback',
...
'Username already taken': 'Gebruikersnaam al in gebruik',
'Users': 'Gebruikers',
'value already in database or empty': 'waarde al in database of leeg',
'Value not in database': 'Veld niet in database',
'Verify': 'Verifieer',
...
'Wijzig Wachtwoord': 'Wijzig Wachtwoord',
